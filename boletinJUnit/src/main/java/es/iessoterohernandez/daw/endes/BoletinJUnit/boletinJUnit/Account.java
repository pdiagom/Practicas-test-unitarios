...
public class Account
{
    ...
    {
    	//Creo una variable auxiliar valido
    	//para realizar la comprobacion que devolvere 
    	//antes de modificar los valores
    	boolean valido=isValidWithdrawl(amount, fee);
        if (valido)
        {
            amount += fee;
            balance = balance - amount;
    ...
    {
    	//He suprimido el = de amount>=0 ya que considero 
    	//que no puedes hacer una retirada de 0€
